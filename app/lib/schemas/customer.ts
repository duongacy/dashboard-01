...
export const customerOptionForSelectSchema = customerSchema.pick({id:true, name:true})
...
export type TCustomerSelectOption = z.infer<typeof customerOptionForSelectSchema>
